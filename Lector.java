...
public class Lector {
    ...
    public void ejecutar(int id) {
        ...
        try {
            ...
            // haz lo que necesites con las líneas del archivo aquí
        } catch (IOException e) {
        ...
        //###################################################################
        //hace las sumas de todos los correos y los pone en el formatp que se pidio
        ...
        for (int i = alfaroID; i <= fin; i++) {
            ...
            // Recorremos las palabras del correo y sumamos su valor
